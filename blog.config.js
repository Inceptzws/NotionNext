...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '99f8cee1633240f7a7d11f572f917dc8',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Inceptzws', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Progressive House Producer', // 作者简介
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1877363995', // 对应歌单的 id
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'E-Music', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/Martix.html', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
  ...
  IMG_URL_TYPE: process.env.NEXT_PUBLIC_IMG_TYPE || 'Notion:(https://notion.so/images/xx)', // 此配置已失效，请勿使用；AMAZON方案不再支持，仅支持Notion方案。 ['Notion','AMAZON'] 站点图片前缀 默认 Notion:(https://notion.so/images/xx) ， AMAZON(https://s3.us-west-2.amazonaws.com/xxx)
